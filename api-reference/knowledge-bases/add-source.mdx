...
```bash curl
curl -X POST https://dev-agentic-os-comms-engine-api-aks.setoo.work/api/v1/knowledge-bases/KB_ID/sources \
...
resp = requests.post(
    "https://dev-agentic-os-comms-engine-api-aks.setoo.work/api/v1/knowledge-bases/KB_ID/sources",
    headers={
...
```javascript Node
await fetch("https://dev-agentic-os-comms-engine-api-aks.setoo.work/api/v1/knowledge-bases/KB_ID/sources", {
  method: "POST",
  headers: {
