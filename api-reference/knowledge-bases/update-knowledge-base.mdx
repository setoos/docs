...
```bash curl
curl -X PATCH https://dev-agentic-os-aks.setoo.work/api/v1/knowledge-bases/KB_ID \
...
```python Python
requests.patch(
    "https://dev-agentic-os-aks.setoo.work/api/v1/knowledge-bases/KB_ID",
...
```javascript Node
await fetch("https://dev-agentic-os-aks.setoo.work/api/v1/knowledge-bases/KB_ID", {
  method: "PATCH",
  headers: {
