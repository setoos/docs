...
```bash curl
curl https://dev-agentic-os-platform-core-api-aks.setoo.work/api/v1/integrations/balances \
  -H "Authorization: Bearer $AGENTIC_OS_API_KEY"
```

```python Python
requests.get(
    "https://dev-agentic-os-platform-core-api-aks.setoo.work/api/v1/integrations/balances",
    headers={"Authorization": f"Bearer {API_KEY}"},
)
```

```javascript Node
await fetch("https://dev-agentic-os-platform-core-api-aks.setoo.work/api/v1/integrations/balances", {
