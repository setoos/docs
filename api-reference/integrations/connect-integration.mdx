...
```bash curl
curl -X POST https://dev-agentic-os-aks.setoo.work/api/v1/integrations \
...
resp = requests.post(
    "https://dev-agentic-os-aks.setoo.work/api/v1/integrations",
    headers={
...
```javascript Node
await fetch("https://dev-agentic-os-aks.setoo.work/api/v1/integrations", {
  method: "POST",
  headers: {
