...
```bash curl
curl https://dev-agentic-os-aks.setoo.work/api/v1/integrations/TWILIO \
  -H "Authorization: Bearer $AGENTIC_OS_API_KEY"
```

```python Python
requests.get(
    "https://dev-agentic-os-aks.setoo.work/api/v1/integrations/TWILIO",
    headers={"Authorization": f"Bearer {API_KEY}"},
)
```

```javascript Node
await fetch("https://dev-agentic-os-aks.setoo.work/api/v1/integrations/TWILIO", {
