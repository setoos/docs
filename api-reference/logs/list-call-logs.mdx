...
```bash curl
curl "https://dev-agentic-os-aks.setoo.work/api/v1/call-logs?status=answered&fromDate=2026-06-01T00:00:00Z&pageSize=25" \
  -H "Authorization: Bearer $AGENTIC_OS_API_KEY"
```

```python Python
requests.get(
    "https://dev-agentic-os-aks.setoo.work/api/v1/call-logs",
...
```javascript Node
await fetch(
  "https://dev-agentic-os-aks.setoo.work/api/v1/call-logs?status=answered&pageSize=25",
