...
```bash curl
curl https://dev-agentic-os-comms-engine-api-aks.setoo.work/api/v1/tools \
...
resp = requests.get(
    "https://dev-agentic-os-comms-engine-api-aks.setoo.work/api/v1/tools",
...
```javascript Node
const resp = await fetch("https://dev-agentic-os-comms-engine-api-aks.setoo.work/api/v1/tools", {
