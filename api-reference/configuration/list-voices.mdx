...
```bash curl
curl "https://dev-agentic-os-comms-engine-api-aks.setoo.work/api/v1/voices?languageCode=en-US&gender=female" \
  -H "Authorization: Bearer $AGENTIC_OS_API_KEY"
```

```python Python
requests.get(
    "https://dev-agentic-os-comms-engine-api-aks.setoo.work/api/v1/voices",
...
```javascript Node
await fetch(
  "https://dev-agentic-os-comms-engine-api-aks.setoo.work/api/v1/voices?languageCode=en-US&gender=female",
