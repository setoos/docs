...
<Callout type="warning">
  You must have an active Agentic OS account to generate and use API keys. For instructions on creating keys, see the [API Keys Guide](/features/api-keys).
</Callout>
...
```bash
https://dev-agentic-os-aks.setoo.work/api/v1
```
