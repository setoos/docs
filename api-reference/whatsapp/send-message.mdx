...
```bash curl
curl -X POST https://dev-agentic-os-comms-engine-api-aks.setoo.work/api/v1/channels/whatsapp/messages \
...
```python Python
requests.post(
    "https://dev-agentic-os-comms-engine-api-aks.setoo.work/api/v1/channels/whatsapp/messages",
