...
```bash curl
curl -X PUT https://dev-agentic-os-campaign-engine-api-aks.setoo.work/api/v1/whatsapp/campaigns/55555555-5555-5555-5555-555555555555 \
...
response = requests.put(
    "https://dev-agentic-os-campaign-engine-api-aks.setoo.work/api/v1/whatsapp/campaigns/55555555-5555-5555-5555-555555555555",
    headers={
