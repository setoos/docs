...
```bash curl
curl -X GET "https://dev-agentic-os-aks.setoo.work/api/v1/sms-agent/campaigns?page=1&pageSize=15" \
...
const response = await fetch(
  "https://dev-agentic-os-aks.setoo.work/api/v1/sms-agent/campaigns?page=1&pageSize=15",
  {
    method: "GET",
