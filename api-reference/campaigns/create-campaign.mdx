...
```bash curl
curl -X POST https://dev-agentic-os-aks.setoo.work/api/v1/campaigns \
...
response = requests.post(
    "https://dev-agentic-os-aks.setoo.work/api/v1/campaigns",
    headers={
...
```javascript Node
const response = await fetch("https://dev-agentic-os-aks.setoo.work/api/v1/campaigns", {
  method: "POST",
  headers: {
