...
```bash curl
curl -X POST https://dev-agentic-os-campaign-engine-api-aks.setoo.work/api/v1/campaigns \
...
```javascript Node
const response = await fetch("https://dev-agentic-os-campaign-engine-api-aks.setoo.work/api/v1/campaigns", {
  method: "POST",
  headers: {
