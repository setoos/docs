...
Creates a new outbound voice calling campaign. A campaign requires an **agent**, a **voice number**, and optionally a **contact list** (which must contain at least 2 contacts before starting).
