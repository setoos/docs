...
```bash curl
curl -X POST https://dev-agentic-os-aks.setoo.work/api/v1/contact-lists/33333333-3333-3333-3333-333333333333/upload \
...
with open("leads.csv", "rb") as f:
    response = requests.post(
        "https://dev-agentic-os-aks.setoo.work/api/v1/contact-lists/33333333-3333-3333-3333-333333333333/upload",
