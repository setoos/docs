...
```bash curl
curl -X POST https://dev-agentic-os-campaign-engine-api-aks.setoo.work/api/v1/whatsapp/campaigns \
...
response = requests.post(
    "https://dev-agentic-os-campaign-engine-api-aks.setoo.work/api/v1/whatsapp/campaigns",
    headers={
