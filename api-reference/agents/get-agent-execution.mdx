...
```bash curl
curl https://dev-agentic-os-aks.setoo.work/api/v1/agents/AGENT_ID/executions/EXECUTION_ID \
  -H "Authorization: Bearer $AGENTIC_OS_API_KEY"
```

```python Python
requests.get(
    "https://dev-agentic-os-aks.setoo.work/api/v1/agents/AGENT_ID/executions/EXECUTION_ID",
