...
```bash curl
curl -X POST https://dev-agentic-os-aks.setoo.work/api/v1/agents/AGENT_ID/stop-calls \
  -H "Authorization: Bearer $AGENTIC_OS_API_KEY"
```

```python Python
requests.post(
    "https://dev-agentic-os-aks.setoo.work/api/v1/agents/AGENT_ID/stop-calls",
