...
```bash curl
curl -X POST https://dev-agentic-os-aks.setoo.work/api/v1/tools/agents/BRAIN_ID/bindings \
...
resp = requests.post(
    "https://dev-agentic-os-aks.setoo.work/api/v1/tools/agents/BRAIN_ID/bindings",
    headers={
...
```javascript Node
await fetch("https://dev-agentic-os-aks.setoo.work/api/v1/tools/agents/BRAIN_ID/bindings", {
  method: "POST",
  headers: {
