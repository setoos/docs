...
```bash curl
curl -X POST https://dev-agentic-os-comms-engine-api-aks.setoo.work/api/v1/channels/web/session \
...
```python Python
requests.post(
    "https://dev-agentic-os-comms-engine-api-aks.setoo.work/api/v1/channels/web/session",
...
```javascript Node
await fetch("https://dev-agentic-os-comms-engine-api-aks.setoo.work/api/v1/channels/web/session", {
  method: "POST",
  headers: {
