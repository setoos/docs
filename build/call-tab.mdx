...
|---|---|---|
| **Max Call Duration** | Maximum call duration, what happens when the limit is reached, and allowed range/unit | `90 seconds` |
| **Silence Timeout** | What counts as silence, when the timer starts, and what happens after timeout | `10 seconds` |
| **Telephony Provider** | Supported providers (Twilio, Plivo, Acefone) and how to configure/select them | `Tenant default` |
| **Caller ID** | Purpose, source of the number, requirements, and outbound-call behavior | `—` (Unset) |
